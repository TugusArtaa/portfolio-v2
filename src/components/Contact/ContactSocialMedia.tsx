        ...
        <div className="w-full flex justify-center sm:w-auto sm:inline-flex">
          {socialLinks
            ...
            .map((s) => (
              <div
                key={s.id}
                className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-sky-200/30 dark:border-sky-400/20 shadow-md shadow-sky-400/5 dark:shadow-sky-500/10 hover:shadow-lg transition-all duration-300 mt-2 sm:mt-0"
              >
