        ...
        {socialLinks
          ...
          .map((s) => (
            <a
              ...
              className={`group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/80 backdrop-blur-sm border border-zinc-200 shadow-sm transition-all duration-300 hover:shadow-md hover:scale-110 text-zinc-600 ${s.color}`}
              aria-label={s.id}
            >
              {s.icon}
            </a>
          ...
          {socialLinks
            ...
            .map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-xl bg-white/80 backdrop-blur-sm border border-zinc-200 shadow-sm hover:shadow-md transition-all duration-300 mt-2 sm:mt-0 cursor-pointer hover:scale-105"
                aria-label="Join Discord Server"
              >
                <span className="text-zinc-600 group-hover:text-indigo-500 transition-colors duration-300">
                  {s.icon}
                </span>
                <span className="text-zinc-800 font-medium text-xs sm:text-sm group-hover:text-indigo-500 transition-colors duration-300">
                  {s.label}
                </span>
              </a>
            ))}
